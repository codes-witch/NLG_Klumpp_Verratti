...
def get_args(arg_str=None):
    """
    Get the necessary arguments (model settings, training parameters, choice of dataset etc.)

    :param arg_str: a string representing
    ...
    # choose the model (among lrcn, gve, and sc)
    parser.add_argument('--model', type=str, default='lrcn',
                        help="deep learning model",
                        choices=['lrcn', 'gve', 'sc'])
    parser.add_argument('--dataset', type=str, default='coco',
                        choices=['coco', 'cub'])
    # set model-specific parameters for the chosen model
    ...
    # set embedding and hidden sizes for the network
    ...
    # if no arg_str is given, take the arguments as specified above
    if arg_str is None:
        args = parser.parse_args()
    # if an arg_str is given, adjust arguments accordingly
    else:
    ...
    # TODO: I do not really understand this
    ...
    # if the seed is specified in the arguments, use the specified value
    if args.torch_seed is not None:
        torch.manual_seed(arg_vars["torch_seed"])
    # else use the initial value
    else:
