...
class KeywordClassifier(object):
    ...
    # TODO (Danielas notes: In general: sets the following instance variable:
    # - Rsa_dataset
    ...
    # note (Daniela): seems to be misbehaving. Only prints head and tail
    ...
    def expand(self):
        """
        Adds synonyms to the organ names in organ_name_to_match_words dictionary, using fill_organ_key_words
        """
